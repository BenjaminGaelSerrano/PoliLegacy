...
func cargarPaso(n: int):
	...
	match n:
		...
		2: etiqueta.text = "Presioná E de nuevo para recibir el libro"
		3: etiqueta.text = "Presioná L para abrir el libro y leerlo"
		4: etiqueta.text = "Presioná Click Izquierdo para disparar"
		5: _fin_tutorial()
func _on_movimiento():
